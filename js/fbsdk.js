...
async function statusChangeCallback(response) {
  if (response.status === 'connected') {
    ...
    if (window.location.href == "https://pclinh.github.io/post.html" || window.location.href == "https://pclinh.com/post.html") {
      getPost();
    }
    if (window.location.href == "https://pclinh.github.io/homepage.html" || window.location.href == "https://pclinh.com/homepage.html") {
      FB.api(
